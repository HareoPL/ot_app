...
TEST(ot_app_pair, GivenNullDeviceList_WhenCallingDeviceAdd_ThenReturnError)
{
    ...
    result = otapp_pair_DeviceAdd(NULL, deviceNameFull_1, &ipAddr);
...
{
    int8_t result;
    result = otapp_pair_DeviceAdd(otapp_pair_getHandle(), deviceNameFull_1, NULL);
...
TEST(ot_app_pair, GivenTwiceSameDeviceName_WhenCallingDeviceAdd_ThenReturnError)
{
    int8_t result;
             otapp_pair_DeviceAdd(otapp_pair_getHandle(), deviceNameFull_1, &ipAddr);
    result = otapp_pair_DeviceAdd(otapp_pair_getHandle(), deviceNameFull_1, &ipAddr);
...
{
    int8_t result;
    result = otapp_pair_DeviceAdd(otapp_pair_getHandle(), deviceNameFull_MaxLength11, &ipAddr);
...
TEST(ot_app_pair, GivenMaxDevices_WhenCallingDeviceAdd_ThenReturnIndex9)
{
    ...
    result = otapp_pair_DeviceAdd(otapp_pair_getHandle(), deviceNameFull_10, &ipAddr);
